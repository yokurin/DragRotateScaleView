#
# Be sure to run `pod lib lint DragRotateScaleView.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'DragRotateScaleView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DragRotateScaleView' => ['DragRotateScaleView/Assets/*.png']
  # }
